...
const About = () => {
  return (
    <div className="bg-white min-h-screen pt-24 pb-12">
      {/* Hero Section */}
      <section className="section-padding bg-gradient-to-b from-warm-amber/20 to-transparent relative overflow-hidden">
      ...
      {/* Propósito */}
      <section className="section-padding bg-gradient-to-r from-warm-amber/20 to-transparent relative overflow-hidden">
        ...
        <div className="section-container relative z-10">
          ...
          >
            <h2 className="text-4xl font-bold text-warm-brown mb-8">
              Nuestro <span className="text-brand-red">Propósito</span>
            </h2>
            <p className="text-xl text-warm-brown/80 leading-relaxed mb-8 border-l-4 border-brand-red pl-6 py-4">
      ...
      <section className="section-padding">
        <div className="section-container">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="bg-white rounded-lg border-2 border-warm-amber/40 p-12 warm-shadow"
          >
            <h3 className="text-3xl font-bold text-warm-brown mb-6">
      ...
      <section className="section-padding bg-warm-cream/50">
        <div className="section-container">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="bg-white rounded-lg border border-warm-amber/40 p-12 warm-shadow"
          >
            <h3 className="text-3xl font-bold text-warm-brown mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white rounded-lg border border-warm-amber/40 p-8 text-center warm-shadow"
              >
                <div className="text-4xl mb-4">{team.icon}</div>
                <h4 className="text-xl font-bold text-warm-brown mb-3">{team.name}</h4>
                <p className="text-warm-brown/70">{team.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
