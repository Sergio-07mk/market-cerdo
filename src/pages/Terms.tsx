    ...
    <div className="bg-black min-h-screen pt-24 pb-12">
      <div className="section-container max-w-3xl">
        ...
        >
          ...
          <p className="text-white/60">Última actualización: {new Date().toLocaleDateString('es-CO')}</p>
        </motion.div>
        ...
        <motion.div
          ...
          className="prose prose-invert max-w-none text-white/70 leading-relaxed space-y-8"
        >
          <section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">3. Uso Permitido</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">4. Productos y Disponibilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">5. Contenido de Usuario</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">6. Privacidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">8. Enlaces Externos</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">10. Cambios en los Términos</h2>
            <p>
